###
# Robot-Framework image. Taken from https://blog.jdriven.com/2021/05/create-a-docker-image-running-robot-framework/
#
...
###
FROM python:3
LABEL name="Docker build of Robot Framework"
RUN apt-get update \
...
###
# End of Robot-Framework image. Taken from https://blog.jdriven.com/2021/05/create-a-docker-image-running-robot-framework/
###